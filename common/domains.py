...
from sdf import signed_distance_to_zero_level_set
...
def rectangular_domain(dx, p1, p2):
    ...
    rect = mesh.create_rectangle(MPI.COMM_WORLD, [np.array(p1), np.array(p2)], (nx, ny), cell_type=mesh.CellType.triangle)
